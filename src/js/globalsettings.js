...
var GLOBALDATA = {
  ...
  highlightSelectInteraction: [
    { label: "Node", interactionLabel:"Highlight Node", id: "highlightNode", active: false, color: "#FAEACB" },
    { label: "Ancestors", interactionLabel:"Show All Ancestors" ,id: "highlightAncestors", active: false, color: "#F7DBD7" },
    { label: "Descendants", interactionLabel:"Show All Descendants" ,id: "highlightDescendants", active: false, color: "#9CC0E7" },
    { label: "Direct Children", interactionLabel:"Highlight Children", id: "highlightChildNodes", active: false, color: "#D0B2F1" },
    { label: "Siblings", id: "highlightSiblings",interactionLabel:"Highlight Siblings" ,active: false, color: "#ABD2AC" },
    { label: "Path", id: "highlightPath", interactionLabel:"Show Path Between Nodes",active: false, color: "#9DA2E9" },
  ],
  tooltipFields: [
